...
const Location = () => {
  return (
    <div className="flex h-screen flex-col items-center justify-center p-4 bg-[#001025]">
      {/* Heading */}
      ...
      {/* Google Map Embed */}
      <div className="w-full h-72 sm:h-[8rem]  md:h-[10rem] lg:h-[20rem] 2xl:h-[30rem]   relative">
        <iframe
