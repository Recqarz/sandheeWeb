  ...
  return (
    <header className="absolute top-0 left-0 w-full z-50 py-4">
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        {/* Navigation */}
        <nav
          className={`fixed top-0 left-0 w-full h-full md:relative md:h-auto md:w-auto bg-black bg-opacity-90 md:bg-transparent flex flex-col md:flex-row items-center justify-center md:justify-end transition-transform duration-300 ${
            isMobileMenuOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
          } z-40`}
        >
          <ul className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-6 p-8 md:p-0">
            {[
              { name: "HOME", path: "/" },
